...
"[project]/client/node_modules/@google/genai/dist/node/index.mjs [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$google$2d$auth$2d$library$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/client/node_modules/google-auth-library/build/src/index.js [app-rsc] (ecmascript)");
...
class NodeAuth {
    constructor(opts){
        ...
        this.googleAuth = new __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$google$2d$auth$2d$library$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GoogleAuth"](vertexAuthOptions);
    }
 ...
 */ class NodeUploader {
    async stat(file) {
        ...
        if (typeof file === 'string') {
            const originalStat = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["stat"])(file);
    ...
    async uploadFileFromPathInternal(file, uploadUrl, apiClient) {
        ...
        let uploadCommand = 'upload';
        let fileHandle;
        const fileName = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["basename"])(file);
        try {
            fileHandle = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["open"])(file, 'r');
            if (!fileHandle) {
...
//# sourceMappingURL=add2e_%40google_genai_dist_node_index_mjs_01feb036._.js.map